<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="movie2.aspx.cs" Inherits="ProjectIBTnew.wwwroot.html.movie2" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="form1" runat="server">
			<h1 class="title" id="main_title" >Star Wars: Episode III<br> - Revenge of the Sith</h1>
			...
			<img src="../images/sith-cover.png" class="cover" alt="Cover photo" width="371" height="507"/>
			<img src="../images/revenge.png" class="photo" alt="Photo from movie" width="600" height="392"/>


			<div class="info">
				<h2>Plot of the movie:</h2>
				<p>&nbsp;&nbsp;&nbsp;Nearly three years have passed since the beginning of the Clone Wars.
					The Republic, with the help of the Jedi, take on Count Dooku and the Separatists.
					With a new threat rising, the Jedi Council sends Obi-Wan Kenobi and Anakin Skywalker
					to aid the captured Chancellor. Anakin feels he is ready to be promoted to Jedi Master.
					Obi-Wan is hunting down the Separatist General, Grievous. When Anakin has future visions
					of pain and suffering coming Padmé's way, he sees Master Yoda for counsel. When Darth Sidious
					executes Order 66, it destroys most of all the Jedi have built. Experience the birth of Darth Vader.
					Feel the betrayal that leads to hatred between two brothers. And witness the power of hope.</p>
				<h2 class="price">Цена на билет: 8,99лв.</h2>
